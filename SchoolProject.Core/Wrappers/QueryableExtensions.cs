...
namespace SchoolProject.Core.Wrappers
{
    ...
    {
        //this is xtension method to add a ToPaginatedListAsync method to every source or data with type IQueryable and it has pageNumber and pageSize properities
        //we make it <t> Generic to deal with all entity types, student or departments.
